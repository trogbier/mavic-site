                ...
                <div className="benefits_items">
                    <div className="benefits_item">
                        ...
                        <div className="benefits_info">
                            ...
                            <p className="benefits_info-text">Mavic 2 унаследовал 6 стандартных режимов интеллектуальной
                                съемки
                    ...
                    <div className="benefits_item">
                        ...
                        <div className="benefits_info">
                            ...
                            <p className="benefits_info-text">Усовершенствованный режим второго поколения распознаёт и
