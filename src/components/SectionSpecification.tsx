                ...
                <div className="container">
                    ...
                    <div className="specification_inner">
                        <div className="specification_item">
                            <div className="specification_box specification_box-1">
                                <h4 className="specification_box-title">Dlog-M 10 бит</h4>
                                <p className="specification_box-text">Mavic 2 Pro поддерживает цветовой профиль Dlog-M
                                    10
                                    бит с более широким
                                    динамическим диапазоном, дающим больше возможностей для цветокоррекции.
                                </p>
                            </div>
                            <div className="specification_box specification_box-2">
                        ...
                        <div className="specification_item specification_item-center">
                            <img src={mavic} alt=""/>
                        </div>

                        <div className="specification_item">
                            <div className="specification_box specification_box-3">
                                <h4 className="specification_box-title">Матрица CMOS 1</h4>
                                <p className="specification_box-text">Зона активной работы новой 1-дюймовой матрицы CMOS
                                    в
                                    четыре раза превышает
                                    показатели Mavic Pro
                                </p>
                            </div>
                            <div className="specification_box specification_box-4">
                                <h4 className="specification_box-title">Видео HDR</h4>
                                <p className="specification_box-text">Благодаря поддержке видео 4K HDR 10 бит, Mavic 2
                                    Pro
